...
- Public API host selection for Production, RVT, and Rivian is part of the API documentation scope. Do not publish tenant identifiers, custom field data, keys, or customer configuration.
...
- Keep guide and authentication prose under review when the contract changes. Playground requests go directly to the chosen Flow API host.
